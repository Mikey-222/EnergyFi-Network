...
export type DataKey =
  ...
  | { tag: "KwhPrice"; values: void }
  | { tag: "PaymentAsset"; values: void }
  | { tag: "Name"; values: void }
  | { tag: "Symbol"; values: void }
  | { tag: "Credit"; values: readonly [string] };
...
export interface Client {
   ...
   */
  buy_credits: (
    { buyer, kwh }: { buyer: string; kwh: i128 },
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<null>>;
  ...
  get_balance: (
    ...
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<CreditBalance>>;
   ...
   */
  consume_credits: (
    { account, kwh }: { account: string; kwh: i128 },
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<null>>;
}
export class Client extends ContractClient {
  static async deploy<T = Client>(
    /** Constructor/Initialization Args for the contract's `__constructor` method */
    {
      ...
      name,
      symbol,
    }: { admin: string; payment_asset: string; kwh_price: i128; name: string; symbol: string },
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "",
